                ...
                {this.props.messages.map(msg => {
                    return (
                        <Message
                            ...
                            handleFavoriteNumbers={()=> this.props.handleFavoriteNumbers(msg.id, msg.favoritesUsers)}
                            handleRetweetNumbers={() => this.props.handleRetweetNumbers(msg.id,msg.retweetsUsers)}
                        />
                    )
